 ...
 const LandingPage=()=> {
  ...
  return (
    <div className='h-[31rem]'>
      ...
      {/* <div className="flex"><h1 className="absolute mt-10 md:left-40 left-12 font-poppins text-sm font-medium  text-white pt-7 ">Fast, Secure, and Convenient Mobile Recharge Services.</h1></div> */}
      <div className="flex"><h1 className="absolute  md:left-40 left-12 font-poppins text-3xl font-bold  text-white pt-7 ">Instant Mobile Recharge at Your Fingertips!! <br/></h1></div>
      <div className="flex"><h1 className="absolute md:left-40 left-12 font-poppins text-2xl font-extralight  text-white pt-7 mt-[60px]">ReCharge Now... <br/></h1></div>
      </div>
      ...
      <div className="bg-blue-950 lg:h-56 grid grid-cols-12">
        ...
        <div className="flex justify-start pl-12">
          ...
          <div className="flex justify-end pl-80 -mt-1 ">
            <p onClick={()=>setfiber(false)} className= {`${!fiber?'border border-blue-600 text-white rounded-md bg-blue-600 font-montserrat px-2 cursor-pointer':'  text-black rounded-md  font-montserrat px-2 cursor-pointer text-xl'}`}>Mobile</p><p className="mr-2 ml-2"> / </p>
            <p onClick={()=>setfiber(true)} className= {`${fiber?'border border-blue-600 text-white rounded-md bg-blue-600 font-montserrat px-2 cursor-pointer':'  text-black rounded-md  font-montserrat px-2 cursor-pointer text-xl'}`}>Fiber</p>
          </div>
              </div>
          <form>
            {!fiber&&(<div className={`grid grid-cols-2 grid-rows-2 gap-3 px-4 pt-5  ${fiber?"":""}`}>
        ...
        <div className="mb-4">
          ...
          >
            ...
            <option value="offer1">Silver</option>
            <option value="offer2">Gold</option>
            <option value="offer3">Platinum</option>
          </select>
        </div>
        </div>)}
            {fiber&&(<div className={`grid grid-cols-2 grid-rows-1 gap-3 px-4 pt-5 ${!fiber?"":""}`}>
      ...
      {/* <div className="border rounded-md border-tb  border-tb-black text-3xl text-stroke border-slate-500 w-full py-4 font-poppins font-extrabold text-gray-600">
        <marquee>5% Off on Every Recharge,Enjoy Immediate savings on all your rechargs.  Monthly discount vouchers for partner services like streaming or shopping.  Extra 2GB of data added to your plan during weekends.</marquee>
      </div> */}
          </div>
    </div>
  );
