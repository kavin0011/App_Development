 ...
 const LandingPage=()=> {
  ...
  return (
    <div className='h-[30rem]'>
      <h1 className="absolute md:left-40 left-12 text-white pt-7 text-2xl">Recharge in seconds . . .</h1>
      <div className="bg-blue-900 h-56 grid grid-cols-12">
        <div className='col-span-1'></div>

        <div className="md:col-span-6  col-span-10 relative top-20 md:h-[19rem] bg-white shadow-3xl rounded-lg  md:relative md:top-24 ">
          <div className=" p-4 flex justify-start"><h1 className="text-2xl font-poppins pl-7" > Mobile Recharge & Bill Payments </h1>
            </div>
        ...
        <div className="mb-4">
          ...
          <button className=" border border-black bg-blue-700  hover:bg-blue-900 text-white p-2 rounded-md">
          Continue recharge
        </button>
          </div>
        </div>
